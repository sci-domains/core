...
contract PublicListVerifier is Verifier, Context, DomainManager {
    ...
    function addAddresses(string memory domain, uint256 chainId, address contractAddress) public onlyDomainOwner(domain) {
    ...
    function isVerified(string memory domain, uint256 chainId, address contractAddress) public returns (bool) {
        return verifiedContracts[domain][contractAddress][chainId]
