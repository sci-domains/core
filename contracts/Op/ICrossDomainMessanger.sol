...
// Interface for the Superchain Cross Domain Messenger which facilitates sending messages between a source and a target chain.
interface ICrossDomainMessanger {
    /// @notice Sends a message to a target contract on a different chain.
    ...
    /// @notice Retrieves the address of the sender of the cross-domain message.
